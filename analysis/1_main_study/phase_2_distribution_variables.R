...
# =============================================================================
# MAIN STUDY - PHASE 2 DISTRIBUTION ANALYSIS: ALL VARIABLES
#
# Compares writer and model paragraph distributions across scale, ordinal, and
# nominal annotation variables.
#
...
# - Writes distribution result tables to results/main_phase_2_distribution/.
# - Saves scale correlation figures under figures/main_phase_2_distributions/.
#
# =============================================================================
