...
# =============================================================================
# MAIN STUDY - PHASE 2 VISUALIZATION: DISTRIBUTIONS
#
# Builds distribution plots comparing annotations for writer and model paragraphs.
#
# - Loads phase-2 annotations and phase-1 preference data.
# - Applies preprocessing consistent with the R distribution analysis scripts.
# - Exports split-specific distribution figures to `figures/main_phase_2_distributions/`.
#
# =============================================================================
